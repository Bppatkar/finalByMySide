const About = () => {
  return (
    <>
      <div id="about" className="css-1cfisuf snipcss0-0-0-1 snipcss-SKetV">
        <div className="css-0 snipcss0-1-1-2">
          <h2 className="chakra-heading css-1om66xa snipcss0-2-2-3">
            All
            <span className="snipcss0-3-3-4 style-byvOr" id="style-byvOr">
              {" "}
              About{" "}
            </span>
            Me And My
            <span className="snipcss0-3-3-5 style-Azjzp" id="style-Azjzp">
              {" "}
              Experience
            </span>
          </h2>
          <div className="css-16il1d0 snipcss0-2-2-6"></div>
          <div className="css-14v9ok7 snipcss0-2-2-10">
            <div
              className="about-image-div css-dessuh aos-init snipcss0-3-10-11 aos-animate"
              data-aos="zoom-in"
            >
              <svg
                version="1.1"
              ...
              >
                <path
                  ...
                  id="path13"
                ></path>
                <g id="tshirt" className="snipcss0-5-12-13">
                  <path
                    id="path2"
                ...
                <g id="arms" className="snipcss0-5-12-14">
                  <path
                    id="path7"
                ...
                <g opacity="0.20" id="brows" className="snipcss0-5-12-15">
                  <path
                    id="path12"
                ...
                <g id="head" className="snipcss0-5-12-16">
                  <g id="ccc" className="snipcss0-6-16-17">
                    <rect
                      id="rect15"
                      height="47"
                      width="27"
                  ...
                  <path
                    ...
                    opacity="0.1"
                  ></path>
                  <g id="ears" className="snipcss0-6-16-18">
                    <g id="g28" className="snipcss0-7-18-19">
                      <g id="g22" className="snipcss0-8-19-20">
                        <path
                          id="path20"
                    ...
                    <g id="g38" className="snipcss0-7-18-22">
                      <g id="g32" className="snipcss0-8-22-23">
                        <path
                          id="path30"
                  ...
                  <g id="g43" opacity="0.1" className="snipcss0-6-16-25">
                    <path
                      id="path41"
                      d="M104.6,156.7l27.9,1.1v2.2c0,0-20,6-27,3.4v-5.6L104.6,156.7z"
                    ></path>
                  </g>
                  <g id="chin" className="snipcss0-6-16-26">
                    <path
                      id="path45"
                  ...
                  <g id="face" className="snipcss0-6-16-27">
                    <path
                      id="path48"
                  ...
                  <g id="mouth" className="snipcss0-6-16-28">
                    <path
                      id="path54"
                  ...
                  <g id="hair" className="snipcss0-6-16-29">
                    <g id="sides" className="snipcss0-7-29-30">
                      <g id="g59" className="snipcss0-8-30-31">
                        <path
                          id="path57"
                      ...
                      <g id="g63" className="snipcss0-8-30-32">
                        <path
                          id="path61"
                      ...
                      <g id="g67" className="snipcss0-8-30-33">
                        <path
                          id="path65"
                      ...
                      <g id="g71" className="snipcss0-8-30-34">
                        <path
                          id="path69"
                      ...
                      <g id="g75" className="snipcss0-8-30-35">
                        <path
                          id="path73"
                    ...
                    <g id="stripe" className="snipcss0-7-29-36">
                      <g id="g80" className="snipcss0-8-36-37">
                        <path
                          id="path78"
                      ...
                      <g id="g84" className="snipcss0-8-36-38">
                        <path
                          id="path82"
                      ...
                      <g id="g88" className="snipcss0-8-36-39">
                        <path
                          id="path86"
                      ...
                      <g id="g92" className="snipcss0-8-36-40">
                        <path
                          id="path90"
                      ...
                      <g id="g96" className="snipcss0-8-36-41">
                        <path
                          id="path94"
                      ...
                      <g id="g100" className="snipcss0-8-36-42">
                        <path
                          id="path98"
                  ...
                  <g id="eyeb" className="snipcss0-6-16-43">
                    <g id="g106" className="snipcss0-7-43-44">
                      <path
                        id="path104"
                    ...
                    <g id="g110" className="snipcss0-7-43-45">
                      <path
                        id="path108"
                  ...
                  <g id="eyey2" className="snipcss0-6-16-46">
                    <circle
                      id="circle113"
                      r="5"
                      cy="114"
                ...
                <g id="shirt" className="snipcss0-5-12-47">
                  <path
                    id="path119"
                    ...
                    fill="#dc143c"
                  ></path>
                  <g id="g123" className="snipcss0-6-47-48">
                    <polygon
                      id="polygon121"
                  ...
                  <g id="g127" className="snipcss0-6-47-49">
                    <polygon
                      id="polygon125"
                  ...
                  <g id="gola" className="snipcss0-6-47-50">
                    <g id="g131" className="snipcss0-7-50-51">
                      <path
                        id="path129"
                    ...
                    <g id="g135" className="snipcss0-7-50-52">
                      <path
                        id="path133"
                    ...
                    <g id="g145" className="snipcss0-7-50-53">
                      <g id="g143" className="snipcss0-8-53-54">
                        <g id="g141" className="snipcss0-9-54-55">
                          <path
                            id="path137"
                    ...
                    <g id="g149" className="snipcss0-7-50-56">
                      <path
                        id="path147"
                    ...
                    <g id="g153" className="snipcss0-7-50-57">
                      <circle
                        id="circle151"
                        r="2.2"
                        cy="194.2"
                    ...
                    <g id="g157" className="snipcss0-7-50-58">
                      <circle
                        id="circle155"
                        r="2"
                        cy="202.3"
                    ...
                    <g id="g167" className="snipcss0-7-50-59">
                      <g id="g165" className="snipcss0-8-59-60">
                        <g id="g163" className="snipcss0-9-60-61">
                          <path
                            id="path159"
                  ...
                  <g id="g172" opacity="0.14" className="snipcss0-6-47-62">
                    <path
                      id="path170"
                ...
                <g id="g177" className="snipcss0-5-12-63">
                ...
                <g id="legs" className="snipcss0-5-12-65">
                  <g id="g188" className="snipcss0-6-65-66">
                    <path
                      id="path186"
                  ...
                  <g id="g192" className="snipcss0-6-65-67">
                    <path
                      id="path190"
                  ...
                  <g id="g196" className="snipcss0-6-65-68">
                    <polygon
                      id="polygon194"
                  ...
                  <g id="g200" className="snipcss0-6-65-69">
                    <polygon
                      id="polygon198"
                  ...
                  <g id="notebook" className="snipcss0-6-65-70">
                    <g id="g210" className="snipcss0-7-70-71">
                      <g id="g204" className="snipcss0-8-71-72">
                        <path
                          id="path202"
                      ...
                      <g id="g208" className="snipcss0-8-71-73">
                        <path
                          id="path206"
                    ...
                    <g id="logobook" className="snipcss0-7-70-74">
                      <rect
                        rx="3"
                        id="rect1150"
                        fill="#dc143c"
                  ...
                  <g id="g218" opacity="0.1" className="snipcss0-6-65-76">
                    <polygon
                      id="polygon216"
                      points="135.8,341 132.4,341.2 134.8,330.6 136,330.5   "
                    ></polygon>
                  </g>
                  <g id="g222" className="snipcss0-6-65-77">
                    <path
                      id="path220"
                  ...
                  <g id="g226" className="snipcss0-6-65-78">
                    <path
                      id="path224"
                  ...
                  <g id="g230" className="snipcss0-6-65-79">
                    <path
                      id="path228"
                  ...
                  <g id="g234" opacity="0.1" className="snipcss0-6-65-80">
                    <polygon
                      id="polygon232"
                      points="150.4,357.3 145.7,357.4 146.8,348 149.4,351.4   "
                    ></polygon>
                  </g>
                  <g id="g238" className="snipcss0-6-65-81">
                    <polygon
                      id="polygon236"
                  ...
                  <g id="pe" className="snipcss0-6-65-82">
                    <g id="g242" className="snipcss0-7-82-83">
                      <path
                        id="path240"
                    ...
                    <g id="g246" className="snipcss0-7-82-84">
                      <rect
                        id="rect244"
                        height="7.9"
                        width="1.9"
                    ...
                    <g id="g250" className="snipcss0-7-82-85">
                      <rect
                        id="rect248"
                        height="7.6"
                        width="1.9"
                    ...
                    <g id="g254" className="snipcss0-7-82-86">
                      <rect
                        id="rect252"
                        height="7"
                        width="1.9"
                    ...
                    <g id="g258" className="snipcss0-7-82-87">
                      <rect
                        id="rect256"
                        height="6.1"
                        width="1.9"
                  ...
                  <g id="g263" className="snipcss0-6-65-88">
            ...
            <div
              data-aos="zoom-in"
              className="css-1soe4kc aos-init snipcss0-3-10-89 aos-animate"
            >
              <ul role="list" className="css-tu0njr snipcss0-4-89-90">
                <li className="css-1e9vkru snipcss0-5-90-91">
                  Hello! My name is <b> Bhanu Pratap Patkar </b> &amp; I enjoy
                  creating things that live on the internet. I'm a passionate
                  Developer, with strong administrative &amp; communication
                  skills, good attention to detail &amp; the ability to write
                  efficient code.
                </li>
                <li className="css-1e9vkru snipcss0-5-90-92">
                  After completing my React JS course, I had the opportunity to
                  become a Web Developer Intern at <b>Innobyte Services </b>.
                  During my internship, I created a VPN service landing page as
                  my first assignment.
                </li>
                <li className="css-1e9vkru snipcss0-5-90-93">
                  Fast forwarding to today, I am working as an intern in
                  Innobyte Services. After finishing this internship, I joined{" "}
                  <b>Tech OctaNet Pvt Ltd. </b> Web Dev Internship. Through much
                  preparation, dedication, and consistency, I was able to
                  achieve this milestone. As I begin the next chapter of my
                  career, I am eager to learn, grow, and contribute to my new
                  role.
                </li>
              </ul>
            </div>
